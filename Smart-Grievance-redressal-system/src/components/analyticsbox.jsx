  ...
  return (
    <Paper
      ...
      sx={{
        padding: "20px",
        textAlign: "center",
        backgroundColor: fullback(title),
        borderRadius: "16px",
      }}
    >
      <Stack
        sx={{ color: titelcolor(title) }}
        alignItems="center"
      ...
      >
        ...
        <Stack
          ...
          justifyContent="center"
          sx={{
            backgroundColor: iconcolor(title),
            borderRadius: "50%",
            width: 50,
            height: 50,
          }}
      ...
      <Stack variant="caption" sx={{ color: titelcolor(title) }}>
        {" "}
        0 of 1 resolved
      </Stack>
    </Paper>
